...
htmlhelp_basename = u'观测资料的解码，质控和格式转换'
...
man_pages = [
    (master_doc, 'obsproc', u'ObsProc Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ObsProc', u'ObsProc Documentation',
     author, 'ObsProc', 'One line description of project.',
     'Miscellaneous'),
]