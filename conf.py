...
latex_documents = [
  ('index', 'obsproc.tex', u'Obsproc Documentation',
...
#
man_pages = [
    ('obsproc', 'obsproc', u'Lightweight user-defined software stacks for high-performance computing',
     [u'北京朗润知天科技有限公司'], 1),
    ('ch-build', 'ch-build', u'Wrapper for "docker build" that works around some of its annoying behaviors',
     [u'北京朗润知天科技有限公司'], 1),
    ('ch-build2dir', 'ch-build2dir', u'Build a obsproc image from Dockerfile and unpack it',
     [u'北京朗润知天科技有限公司'], 1),
    ('ch-docker2tar', 'ch-docker2tar', u'Flatten a Docker image into a obsproc image tarball',
     [u'北京朗润知天科技有限公司'], 1),
    ...
    ('ch-pull2tar', 'ch-pull2tar', u'Pull image from Docker Hub and flatten into tarball',
     [u'北京朗润知天科技有限公司'], 1),
    ('ch-run', 'ch-run', u'Run a command in a obsproc container',
     [u'北京朗润知天科技有限公司'], 1),
    ('ch-ssh', 'ch-ssh', u'Run a remote command in a obsproc container',
     [u'北京朗润知天科技有限公司'], 1),
...
texinfo_documents = [
  ('index', 'Obsproc', u'Obsproc Documentation',
   u'北京朗润知天科技有限公司', 'obsproc', 'One line description of project.',
   'Miscellaneous'),
]
